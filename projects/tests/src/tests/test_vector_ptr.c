...
UTEST_F_SETUP(TestVectorPtr) {
    VEC = vector_create(0, VECTOR_SPECS(TestObject*, &test_object_destroy));
}
...
UTEST_F(TestVectorPtr, vector_extend_back1) {
    TestObject* values[] = {
        test_object_allocate(1, 11, 10),
        test_object_allocate(2, 22, 20),
        test_object_allocate(3, 33, 30),
...
UTEST_F(TestVectorPtr, vector_extend_back2) {
    TestObject* values[] = {
        test_object_allocate(1, 11, 10),
        test_object_allocate(2, 22, 20),
        test_object_allocate(3, 33, 30),
...
UTEST_F(TestVectorPtr, vector_extend_front1) {
    TestObject* values[] = {
        test_object_allocate(1, 11, 10),
        test_object_allocate(2, 22, 20),
        test_object_allocate(3, 33, 30),
...
UTEST_F(TestVectorPtr, vector_extend_front2) {
    TestObject* values[] = {
        test_object_allocate(1, 11, 10),
        test_object_allocate(2, 22, 20),
        test_object_allocate(3, 33, 30),
