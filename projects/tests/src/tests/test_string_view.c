...
UTEST(TestStringView, string_view_eq_bytes2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_FALSE(string_view_eq_bytes(&sv, "", 1));
}

UTEST(TestStringView, string_view_eq_bytes3) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_FALSE(string_view_eq_bytes(&sv, "hello", 6));
}

UTEST(TestStringView, string_view_eq_bytes4) {
    StringView sv = string_view_from_cstr("hello");
    ASSERT_FALSE(string_view_eq_bytes(&sv, "", 0));
}
...
// -- comparison:string_view_cmp_cstr --

UTEST(TestStringView, string_view_cmp_cstr1) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_EQ(0, string_view_cmp_cstr(&sv, NULL));
}

UTEST(TestStringView, string_view_cmp_cstr2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_GT(0, string_view_cmp_cstr(&sv, "apple"));
}

UTEST(TestStringView, string_view_cmp_cstr3) {
    StringView sv = string_view_from_cstr("apple");
    ASSERT_LT(0, string_view_cmp_cstr(&sv, NULL));
}

UTEST(TestStringView, string_view_cmp_cstr4) {
    StringView sv = string_view_from_cstr("apple");
    ASSERT_EQ(0, string_view_cmp_cstr(&sv, "apple"));
}

UTEST(TestStringView, string_view_cmp_cstr5) {
    StringView sv = string_view_from_cstr("apple");
    ASSERT_GT(0, string_view_cmp_cstr(&sv, "apples"));
}

// -- comparison:string_view_cmp_bytes --

UTEST(TestStringView, string_view_cmp_bytes1) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_EQ(0, string_view_cmp_bytes(&sv, NULL, 0));
}

UTEST(TestStringView, string_view_cmp_bytes2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_GT(0, string_view_cmp_bytes(&sv, "apple", 6));
}

UTEST(TestStringView, string_view_cmp_bytes3) {
    StringView sv = string_view_from_cstr("apple");
    ASSERT_LT(0, string_view_cmp_bytes(&sv, NULL, 0));
}

UTEST(TestStringView, string_view_cmp_bytes4) {
    StringView sv = string_view_from_cstr("apple");
    ASSERT_GT(0, string_view_cmp_bytes(&sv, "apple", 6));
}

UTEST(TestStringView, string_view_cmp_bytes5) {
    StringView sv = string_view_from_cstr("apple");
    ASSERT_GT(0, string_view_cmp_bytes(&sv, "apples", 7));
}

// -- comparison:string_view_cmp_sv --

UTEST(TestStringView, string_view_cmp_sv1) {
    StringView sv1 = string_view_from_cstr(NULL);
    StringView sv2 = string_view_from_cstr(NULL);
    ASSERT_EQ(0, string_view_cmp_sv(&sv1, &sv2));
}

UTEST(TestStringView, string_view_cmp_sv2) {
    StringView sv1 = string_view_from_cstr(NULL);
    StringView sv2 = string_view_from_cstr("apple");
    ASSERT_GT(0, string_view_cmp_sv(&sv1, &sv2));
}

UTEST(TestStringView, string_view_cmp_sv3) {
    StringView sv1 = string_view_from_cstr("apple");
    StringView sv2 = string_view_from_cstr(NULL);
    ASSERT_LT(0, string_view_cmp_sv(&sv1, &sv2));
}

UTEST(TestStringView, string_view_cmp_sv4) {
    StringView sv1 = string_view_from_cstr("apple");
    StringView sv2 = string_view_from_cstr("apple");
    ASSERT_EQ(0, string_view_cmp_sv(&sv1, &sv2));
}

UTEST(TestStringView, string_view_cmp_sv5) {
    StringView sv1 = string_view_from_cstr("apple");
    StringView sv2 = string_view_from_cstr("apples");
    ASSERT_GT(0, string_view_cmp_sv(&sv1, &sv2));
}
...
UTEST(TestStringView, string_view_has_prefix_bytes2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_FALSE(string_view_has_prefix_bytes(&sv, "sub", 4));
}
...
UTEST(TestStringView, string_view_has_prefix_bytes5) {
    StringView sv = string_view_from_cstr("substring");
    ASSERT_FALSE(string_view_has_prefix_bytes(&sv, "syb", 4));
}

UTEST(TestStringView, string_view_has_prefix_bytes6) {
    StringView sv = string_view_from_cstr("substring");
    ASSERT_FALSE(string_view_has_prefix_bytes(&sv, "substring", 10));
}

UTEST(TestStringView, string_view_has_prefix_bytes7) {
    StringView sv = string_view_from_cstr("substring");
    ASSERT_FALSE(string_view_has_prefix_bytes(&sv, "substrings", 10));
}
...
UTEST(TestStringView, string_view_has_suffix_bytes2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_FALSE(string_view_has_suffix_bytes(&sv, "string", 4));
}
...
UTEST(TestStringView, string_view_has_suffix_bytes4) {
    StringView sv = string_view_from_cstr("substring");
    ASSERT_FALSE(string_view_has_suffix_bytes(&sv, "string", 7));
}
...
UTEST(TestStringView, string_view_has_suffix_bytes6) {
    StringView sv = string_view_from_cstr("substring");
    ASSERT_FALSE(string_view_has_suffix_bytes(&sv, "substring", 10));
}

UTEST(TestStringView, string_view_has_suffix_bytes7) {
    StringView sv = string_view_from_cstr("substring");
    ASSERT_FALSE(string_view_has_suffix_bytes(&sv, "substrings", 10));
}
...
UTEST(TestStringView, string_view_subview4) {
    ...
    ASSERT_STRNEQ("hello", sub.data, 5);
    ASSERT_EQ(5, sub.len);
}
...
UTEST(TestStringView, string_view_subview5) {
    ...
    ASSERT_STRNEQ("hello world", sub.data, 11);
...
UTEST(TestStringView, string_view_subview6) {
    ...
    ASSERT_STRNEQ("world", sub.data, 5);
    ASSERT_EQ(5, sub.len);
}
...
UTEST(TestStringView, string_view_count_runes4) {
    ...
    ASSERT_EQ(UNICODE_LEN_INVALID, string_view_count_runes(&sv));
}
...
UTEST(TestStringView, string_view_contains_bytes2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_FALSE(string_view_contains_bytes(&sv, "a", 2));
}
...
UTEST(TestStringView, string_view_contains_bytes5) {
    StringView sv = string_view_from_cstr("hello");
    ASSERT_FALSE(string_view_contains_bytes(&sv, "l", 2));
}

UTEST(TestStringView, string_view_contains_bytes6) {
    StringView sv = string_view_from_cstr("hello");
    ASSERT_FALSE(string_view_contains_bytes(&sv, "el", 3));
}
...
UTEST(TestStringView, string_view_find_bytes2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_EQ((u64)NPOS, string_view_find_bytes(&sv, "a", 2));
}
...
UTEST(TestStringView, string_view_find_bytes5) {
    StringView sv = string_view_from_cstr("hello");
    ASSERT_EQ((u64)NPOS, string_view_find_bytes(&sv, "l", 2));
}

UTEST(TestStringView, string_view_find_bytes6) {
    StringView sv = string_view_from_cstr("hello");
    ASSERT_EQ((u64)NPOS, string_view_find_bytes(&sv, "el", 3));
}
...
UTEST(TestStringView, string_view_find_last_bytes2) {
    StringView sv = string_view_from_cstr(NULL);
    ASSERT_EQ((u64)NPOS, string_view_find_last_bytes(&sv, "a", 2));
}
...
UTEST(TestStringView, string_view_find_last_bytes5) {
    StringView sv = string_view_from_cstr("hello");
    ASSERT_EQ((u64)NPOS, string_view_find_last_bytes(&sv, "l", 2));
}

UTEST(TestStringView, string_view_find_last_bytes6) {
    StringView sv = string_view_from_cstr("hello");
    ASSERT_EQ((u64)NPOS, string_view_find_last_bytes(&sv, "el", 3));
}
